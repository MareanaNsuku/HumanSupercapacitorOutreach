...
CC_EMAIL = os.environ.get('CC_EMAIL', 'Mandlenkosisindane43@gmail.com')
CC_LIST = [CC_EMAIL]
...
LinkedIn: <a href="https://www.linkedin.com/in/nsukumareana/">https://www.linkedin.com/in/nsukumareana/</a></p>
    ...
    # Attach design report (must be present in repo)
    docx_path = "Human_Supercapacitor_Project_Design_Report.docx"
...
def search_companies(queries, total_wanted=50):
    ...
    excluded = [
        ...
        'google.com','yelp.com','tripadvisor.com','yellowpages.com','bizcommunity.com',
        ...
        'cylex.co.za','tuugo.co.za','hotfrog.co.za','africanadvice.com','sayellow.co.za',
        'brabys.co.za','zafroms.co.za','infobel.co.za','southafricaonline.co.za',
        'findit.co.za','sabusiness.co.za','localbusiness.co.za','southafrica.com',
        'travelground.com','sa-venues.com','roomsforafrica.com','property24.com',
        'privateproperty.co.za','autotrader.co.za','cars.co.za'
    ]
    for q in queries:
        print(f'🔎 Searching: {q}')
        results = search_duckduckgo(q, max_results=30)
...
def main():
    ...
    queries = [
        ...
        'fitness equipment store South Africa',
        'exercise bike dealer South Africa',
        'gym machine manufacturer South Africa',
        'home gym equipment shop South Africa',
        'fitness accessories supplier South Africa',
        'bicycle shop South Africa',
        'cycling equipment supplier South Africa',
        'solar energy company South Africa',
        'renewable energy developer South Africa',
        'energy storage manufacturer South Africa',
        'battery supplier South Africa',
        'supercapacitor distributor',
        'off-grid power company South Africa',
        'generator supplier South Africa',
        'gym treadmill manufacturer South Africa',
        'fitness equipment factory South Africa',
        'strength equipment supplier South Africa',
        ...
        'mechanical engineering workshop South Africa',
